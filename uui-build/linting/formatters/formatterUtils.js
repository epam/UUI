...
function getSeverityOpts(kind) {
    ...
    let warning;
    if (kind === 'eslint') {
        warning = { id: 1, label: 'Warning', key: 'warning' };
        error = { id: 2, label: 'Error', key: 'error' };
    } else {
        error = { id: 'error', label: 'Error', key: 'error' };
        warning = { id: 'warning', label: 'Warning', key: 'warning' };
    }
