...
function getTestDataSet1() {
    ...
    const B: DataColumnProps = { key: '6', caption: 'b', isAlwaysVisible: true, width: 10 };
    const C: DataColumnProps = { key: '2', fix: 'right', caption: 'c', isAlwaysVisible: false, width: 10 };
    const D: DataColumnProps = { key: '5', caption: 'd', isAlwaysVisible: false, width: 10 };
    const E: DataColumnProps = { key: '4', caption: 'e', isAlwaysVisible: false, width: 10 };
    const F: DataColumnProps = { key: '3', caption: 'f', isAlwaysVisible: false, width: 10 };
    const prevConfig: ColumnsConfig = {
        ...
        [C.key]: { width: 10, fix: 'right', isVisible: true, order: 'c' },
    };
    return { prevConfig, A, B, C, D, E, F };
}
...
describe('columnsConfigurationUtils', () => {
    ...
    describe('isColumnFilteredOut', () => {
        it('should filter out columns without caption', () => {
            const A: DataColumnProps = { key: '1', fix: 'left', caption: '', isAlwaysVisible: false, width: 10 };
