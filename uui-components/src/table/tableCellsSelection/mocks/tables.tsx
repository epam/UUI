...
export const rowsMock: DataRowProps<Row, number>[] = [
    ...
    { id: 3, rowKey: '3', index: 2, value: { age: 30, salary: 3000, name: 'third', phone: 'some phone 3' } },
    { id: 4, rowKey: '4', index: 3, value: { age: 40, salary: 4000, name: 'fourth', phone: 'some phone 4' } },
];
