...
import { ButtonCoreProps, Icon, uuiElement, uuiMarkers, CX, cx, IHasForwardedRef, IHasRawPropsButton } from '@epam/uui-core';
import { IconContainer } from '../layout';
import { ButtonBase } from './ButtonBase';
import * as css from './Button.scss';

export interface ButtonProps extends ButtonCoreProps, IHasRawPropsButton<HTMLButtonElement>, IHasForwardedRef<HTMLButtonElement | HTMLAnchorElement> {
