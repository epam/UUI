...
import { cx, ButtonBaseCoreProps, IHasForwardedRef, UuiContexts, isClickableChildClicked, uuiMod, uuiElement, uuiMarkers, UuiContext, isChildHasClass, IHasRawPropsButton } from '@epam/uui-core';

export interface ButtonBaseProps extends ButtonBaseCoreProps, IHasRawPropsButton<HTMLAnchorElement | HTMLButtonElement>, IHasForwardedRef<HTMLButtonElement | HTMLAnchorElement> {}
...
export abstract class ButtonBase<ButtonProps extends ButtonBaseProps> extends React.Component<ButtonProps> {
    ...
    render(): any {
        ...
        return React.createElement(isAnchor ? 'a' : 'button', {
            ...
            'aria-disabled': this.props.isDisabled as IHasRawPropsButton<HTMLAnchorElement | HTMLButtonElement>['rawProps']['aria-disabled'],
            ...this.props.rawProps,
        },
            this.getChildren(),
        );
