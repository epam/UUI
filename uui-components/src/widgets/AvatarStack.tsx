...
export interface AvatarStackProps extends IHasCX, IHasRawProps<React.HTMLAttributes<HTMLDivElement>>, React.RefAttributes<HTMLDivElement> {
...
export const AvatarStack = (props: AvatarStackProps) => {
    ...
    return (
        <div className={ cx(props.cx, css.root) } ref={ props.ref } { ...props.rawProps }>
