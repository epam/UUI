...
import { IHasCX, Icon, uuiMod, cx, IHasRawProps, IHasForwardedRef } from '@epam/uui';

export interface CarouselProps extends IHasCX, IHasRawProps<HTMLDivElement>, IHasForwardedRef<HTMLDivElement> {
