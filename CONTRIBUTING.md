...
- Clear and descriptive title for the issue to identify the bug;
...
We use property explorer to be able to test component in various variations of props. You can find property explorer tab on the documentation page of each component.
