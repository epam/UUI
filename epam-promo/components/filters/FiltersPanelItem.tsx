    ...
    const getTogglerValue = () => {
        ...
        switch (props.type) {
            case 'multiPicker': {
                ...
                let postfix =
                    currentValue?.length > 2 ? ` +${(currentValue.length - 2).toString()} ${i18n.filterToolbar.pickerInput.itemsPlaceholder}` : null;
                let isLoading = false;
            ...
            case 'datePicker': {
                return {
                    selection: currentValue ? dayjs(currentValue).format(props.format || defaultFormat) : i18n.filterToolbar.datePicker.placeholder,
                };
            }
