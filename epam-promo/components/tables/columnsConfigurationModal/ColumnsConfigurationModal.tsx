...
const renderGroupTitle = (title: string, amount: number) => (
    <FlexRow size="24" padding="24" spacing="6" cx={styles.groupTitle}>
        <Text cx={styles.groupTitleText} font="sans-semibold" lineHeight="24" fontSize="14">
            {title}
        </Text>
            ...
            <ModalWindow height="700">
                ...
                <FlexRow padding="24" borderBottom={true} spacing="12" cx={styles.searchArea}>
                    ...
                    <Dropdown
                        ...
                        renderTarget={props => (
                            <Button cx={styles.actionsMenu} {...props} fill="white" icon={MenuIcon} size="30" color="gray50" isDropdown={false} />
                        )}
                    />
                </FlexRow>
                    ...
                    <ScrollBars>
                        ...
                        {isNoData && (
                            <FlexRow cx={styles.noData}>
                                <Text fontSize="24" lineHeight="30" color="gray80" font="sans-semibold">
                                    {i18nLocal.noResultsFound.text}
                                </Text>
                                <Text fontSize="16" lineHeight="24" font="sans" color="gray80">
                ...
                <ModalFooter borderTop>
                    ...
                    {noVisibleColumns ? (
                        <Tooltip content={i18nLocal.enableAtLeastOneColumnMessage} placement="top-end" color="gray90">
                            {applyButton}
                        </Tooltip>
                    ) : (
                        applyButton
