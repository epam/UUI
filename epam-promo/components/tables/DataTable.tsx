...
export function DataTable<TItem, TId>(props: React.PropsWithChildren<DataTableProps<TItem, TId> & DataTableMods>) {
    ...
    const renderRow = React.useCallback(
        (rowProps: DataRowProps<TItem, TId>) => <DataTableRow key={rowProps.rowKey} size={props.size} borderBottom={props.border} {...rowProps} />,
            ...
            <div className={css.noResults}>
                {props.renderNoResultsBlock ? (
                    ...
                    <>
                        ...
                        <Text cx={css.noResultsTitle} fontSize="24" lineHeight="30" color="gray80" font="sans-semibold">
                            {i18n.dataTable.title}
                        </Text>
                        <Text fontSize="16" lineHeight="24" font="sans" color="gray80">
                            {i18n.dataTable.message}
                        </Text>
                    </>
                )}
            </div>
            ...
            <>
                ...
                {props.exactRowsCount !== 0 ? (
                    <div className={css.listContainer} style={{ minHeight: `${estimatedHeight}px` }}>
                        <div ref={listContainerRef} role="rowgroup" style={{ marginTop: offsetY }} children={rows} />
                    </div>
                ) : (
