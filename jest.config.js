module.exports = {
    collectCoverageFrom: ['**/*.{ts,tsx}', '!src/**/*.d.ts', '!**/*.doc*', '!./app/**/*', '!./infrastructure/**/*'],
    ...
    testPathIgnorePatterns: ['node_modules', 'templates', './next-app'],
    modulePathIgnorePatterns: ['/build/', './next-app'],
    moduleNameMapper: {
