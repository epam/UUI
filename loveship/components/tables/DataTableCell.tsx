...
import { TextPlaceholder, Text } from '../../components';
...
export function DataTableCell<TItem, TId, TCellValue>(props: DataTableCellProps<TItem, TId, TCellValue> & DataTableCellMods) {
    ...
    props.renderTooltip = (tooltipProps) => <Tooltip color='fire' { ...tooltipProps } />;

    const isEditable = !!props.onValueChange;

    props.border = props.border ?? (isEditable ? 'night300' : null);
