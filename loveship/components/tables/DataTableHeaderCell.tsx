...
export class DataTableHeaderCell<TItem, TId> extends React.Component<
    DataTableHeaderCellProps<TItem, TId> & DataTableHeaderCellMods,
...
> {
    ...
    getColumnCaption = () => (
        <div className={css.tooltipWrapper}>
            ...
            >
                ...
                >
                    <Text key="text" cx={cx(css.caption, this.getTextStyle())}>
                        {this.props.column.caption}
                    </Text>
                    {this.props.column.info && (
                        <div>
                            <Text key="tooltip-marker">*</Text>
                        </div>
                    )}
                    ...
                    {this.props.column.isSortable && (!this.props.column.renderFilter || this.props.sortDirection) && (
                        <LinkButton
                            ...
                            color="night400"
                            icon={
                                this.props.sortDirection === 'desc' ? SortIconDesc : this.props.sortDirection === 'asc' ? SortIcon : DefaultSortIcon
                            }
                        />
                    )}
    ...
    renderHeaderCheckbox = () =>
        ...
        this.props.isFirstColumn && <Checkbox size={+this.props.size < 36 ? '12' : '18'} {...this.props.selectAll} cx={css.checkbox} />;
