...
export const FilterItemBody = (props: IFilterItemBodyProps<any>) => {
    switch (props.type) {
        case 'singlePicker':
            return <ColumnPickerFilter {...props} selectionMode="single" valueType="id" />;
        case 'multiPicker':
            return <ColumnPickerFilter {...props} selectionMode="multi" valueType="id" />;
        case 'datePicker':
            return <DatePicker {...props} format="DD/MM/YYYY" />;
