            ...
            <ModalWindow height="700">
                ...
                <FlexRow padding="24" borderBottom={true} spacing="12" cx={styles.searchArea}>
                    ...
                    <Dropdown
                        ...
                        renderTarget={props => (
                            <Button cx={styles.actionsMenu} {...props} fill="white" icon={MenuIcon} size="30" color="night500" isDropdown={false} />
                        )}
                    />
                </FlexRow>
                    ...
                    <ScrollBars>
                        ...
                        {isNoData && (
                            <FlexRow cx={styles.noData} spacing={null}>
                                <Text fontSize="18" lineHeight="30" color="night800" font="sans-semibold">
                                    {i18nLocal.noResultsFound.text}
                                </Text>
                                <Text fontSize="16" lineHeight="24" font="sans" color="night800">
