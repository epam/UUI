        ...
        examples: [
            {
                value: <div style={ { maxWidth: "1100px" } } className={ style.container }>
                    ...
                    <h1>Promo heading — H1 <br/> for page hero-headers</h1>
                    <h2>Promo heading — H2 <br/> for areas smaller than hero-headers</h2>
                    ...
                    <h6>Super small heading or acsent — Emphasis <br/> for title or lable of lists</h6>
                    <h4>Example text</h4>
                    <p>
