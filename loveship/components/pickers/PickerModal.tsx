    ...
    renderRow(rowProps: DataRowProps<TItem, TId>) {
        return this.props.renderRow ? (
            ...
            <DataPickerRow
                ...
                size="36"
                renderItem={i => (
                    <Text size="36" color={rowProps.isDisabled ? 'night500' : 'night700'}>
                        {rowProps.isLoading ? <TextPlaceholder wordsCount={2} /> : this.getName(i)}
                    </Text>
                )}
            />
        );
                    ...
                    <FlexCell cx={css.subHeaderWrapper}>
                        ...
                        {!this.isSingleSelect() && (
                            <Switch
                                ...
                                onValueChange={nV =>
                                    this.setState({ showSelected: nV, dataSourceState: { ...this.state.dataSourceState, search: '' } })
                                }
