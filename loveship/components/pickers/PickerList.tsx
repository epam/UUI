...
import { UuiContexts, DataRowProps, IClickable, IHasCaption, IHasPlaceholder, UuiContext, IHasRawProps } from '@epam/uui-core';
            ...
            <div {...(this.props.rawProps as object)}>
                {!rows.length &&
                    (this.props.noOptionsMessage ? (
                        ...
                        <Text color={this.props.theme === 'dark' ? 'night300' : 'night500'} size={this.props.size as TextSize}>
                ...
                {showPicker &&
                    renderToggler(
                        { onClick: this.handleShowPicker, caption: this.getModalTogglerCaption(viewProps.totalCount, selectedRows.length) },
                        selectedRows
                    )}
            </div>
        );
