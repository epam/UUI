...
describe('PickerInput', () => {
    ...
    beforeEach(() => {
        windowSpy = jest.spyOn(window, 'window', 'get').mockImplementation(() => windowMock);
    });
    ...
    it('should be rendered correctly', async () => {
        const tree = await renderWithContextAsync(
            <PickerInput value={null} onValueChange={jest.fn()} selectionMode="single" dataSource={dataSource} disableClear searchPosition="input" />
        );
