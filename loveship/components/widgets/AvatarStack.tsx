...
export class AvatarStack extends React.Component<AvatarStackProps> {
    getFirstElements() {
        let firstElements = this.props.avatarsCount && (this.props.urlArray.length > this.props.avatarsCount) ? this.props.urlArray.slice(0, this.props.avatarsCount) : this.props.urlArray;
    ...
    render() {
        return <FlexRow>
            ...
            <Text size="36" color="night700" font="sans-semibold" >
                { this.props.avatarsCount && (this.props.urlArray.length > this.props.avatarsCount) ? '+' + (this.props.urlArray.length - this.props.avatarsCount) : null }
            </Text>
        </FlexRow>;
    }
}
