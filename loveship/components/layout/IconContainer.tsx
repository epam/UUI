...
export function applyIconContainerMods(mods: IconContainerMods) {
    return [css.root, styles['color-' + (mods.color || 'night600')]];
}

export const IconContainer = withMods<ControlIconProps, IconContainerMods>(uuiIconContainer, applyIconContainerMods);
