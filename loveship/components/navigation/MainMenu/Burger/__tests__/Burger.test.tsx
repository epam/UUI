...
describe.skip('Burger', () => {
    ...
    beforeEach(() => {
        reactDomSpy = jest.spyOn(ReactDom, 'createPortal').mockImplementation((el: any) => el);
    });
    afterEach(() => {
    ...
    it('should be rendered correctly', () => {
        ...
        const tree = renderer
            .create(<Burger width={50} renderBurgerContent={({ onClose: {} }) => <BurgerButton caption="Home" link={{ pathname: '/' }} />} />)
            .toJSON();
