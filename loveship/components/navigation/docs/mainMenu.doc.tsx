...
import { MainMenuMods, MainMenu, MainMenuButton, FlexSpacer, GlobalMenu, BurgerButton } from "../../../components";
        ...
        examples: [
            ...
            },
            {
                value: [
                    ...
                    <MainMenuButton key='start' caption='Start' collapseToMore priority={ 3 } estimatedWidth={ 62 } showInBurgerMenu/>,
            ...
            },
            {
                value: [
                    ...
                    <MainMenuButton caption='Home' priority={ 4 } collapseToMore estimatedWidth={ 68 } showInBurgerMenu key='home'/>,
