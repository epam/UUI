                ...
                <Dropdown
                    ...
                    renderBody={(props) => (
                        <DropdownMenuBody {...props}>
                            <DropdownMenuButton
                                caption='Promo'
                                isSelected={theme === 'promo'}
                                iconPosition='right'
                                onClick={() => handleTheme('promo')}
                            />
                            <DropdownMenuButton
                                caption='Loveship dark'
                                isSelected={theme === 'loveship_dark'}
                                iconPosition='right'
                                onClick={() => handleTheme('loveship_dark')}
                            />
                        </DropdownMenuBody>
                    )}
                    ...
                    render: () => (
                        <MainMenuCustomElement priority={0} estimatedWidth={113}>
                            <a className={css.linkContainer} href={GIT_LINK}>
                                ...
                                <Text fontWeight='400' fontSize='14' lineHeight='24' cx={css.linkCaption}>
                                    Open Git
                                </Text>
                            </a>
                        </MainMenuCustomElement>
