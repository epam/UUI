import {
    ...
    ModalBlockerProps, ModalFooterCoreProps, ModalHeaderCoreProps, ButtonSemanticProps, LabeledInputCoreProps, ColumnPickerFilterCoreProps, DatePickerCoreProps, RangeDatePickerCoreProps, IFilterItemBodyProps,
} from "../types";
...
export interface ISkin {
    ...
    FilterItemBody: ISkinComponent<IFilterItemBodyProps<any>>;
...
export class SkinContext {
    ...
    public FilterItemBody = <TFilter>(props: IFilterItemBodyProps<TFilter>) => this.skin.FilterItemBody.render(props);
