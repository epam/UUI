...
export interface ITree<TItem, TId, TSubtotals = never> {
  ...
  isFlatList(): boolean;
  setSubtotals(subtotals?: IMap<TId, SubtotalsRecord<TSubtotals>>): ITree<TItem, TId, TSubtotals>;
  getSubtotalRecordByParentId(parentId?: TId): Subtotals<TSubtotals, TId>;
