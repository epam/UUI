import { EMPTY, FULLY_LOADED, LOADING_RECORD, NOT_FOUND_RECORD, PARTIALLY_LOADED } from './constants';
...
export interface ITree<TItem, TId> {
    ...
    getById(id: TId): TItem | typeof LOADING_RECORD | typeof NOT_FOUND_RECORD;
}
