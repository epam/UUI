...
const DndActorComponent = /* @__PURE__ */getDndActorComponent();
export { DndActorComponent as DndActor };

function getDndActorComponent() {
    return class DndActor<TSrcData = any, TDstData = any> extends React.Component<DndActorProps<TSrcData, TDstData>, DndActorState> {
        state = initialState;
