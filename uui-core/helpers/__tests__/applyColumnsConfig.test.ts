...
describe('applyColumnsConfig', () => {
    it('applyColumnsConfig - should exclude invisible columns & sort by order', () => {
        const columns: DataColumnProps[] = [{key: '2', width: 20}, {key: '1', width: 10}, {key: '3', width: 30}];
    ...
    it('applyColumnsConfig - should update fix', () => {
        ...
        const config: ColumnsConfig = {
            ...
            2: { isVisible: true, order: 'b', width: 20, fix: 'left' },
        };
    ...
    it('getColumnsConfig - should build columns config from scratch', () => {
        const columns: DataColumnProps[] = [{key: '3', width: 30, fix: 'left'}, {key: '2', width: 20, isHiddenByDefault: true }, {key: '1', width: 10}];
        const config: ColumnsConfig = {};
        ...
        const expected: ColumnsConfig = {
            ...
            3: { fix: 'left', isVisible: true, order: 's', width: 30 },
        };
