...
export class TableBar extends React.Component<TableProps> {
    ...
    isBlock = (blockType: string) => {
        return (
            this.props.editor.value.anchorBlock &&
            (this.props.editor.value.anchorBlock.type === blockType ||
                (this.props.editor.value.document.getParent(this.props.editor.value.anchorBlock.key) as any).type === blockType)
        );
    };
                        ...
                        {props => (
                            ...
                            >
                                <ToolbarButton
                                    isActive={false}
                                    onClick={() => {
                                        (this.props.editor as any).addNewColumn(this.props, 'before');
                                    }}
                                ...
                                <ToolbarButton
                                    isActive={false}
                                    onClick={() => {
                                        (this.props.editor as any).addNewColumn(this.props);
                                    }}
                                ...
                                <ToolbarButton
                                    isActive={false}
                                    onClick={() => {
                                        (this.props.editor as any).removeSelectedColumn(this.props);
                                    }}
                                    icon={RemoveColumn}
                                />
                                <ToolbarButton
                                    isActive={false}
                                    onClick={() => {
                                        (this.props.editor as any).addNewRow(this.props, 'before');
                                    }}
                                ...
                                <ToolbarButton
                                    isActive={false}
                                    onClick={() => {
                                        (this.props.editor as any).addNewRow(this.props);
                                    }}
                                    icon={InsertRowAfter}
                                />
                                <ToolbarButton
                                    isActive={false}
                                    onClick={() => {
                                        (this.props.editor as any).removeSelectedRow(this.props);
                                    }}
                                    icon={RemoveRow}
                                />
                                <ToolbarButton
                                    isActive={false}
                                    onClick={() => {
                                        (this.props.editor as any).removeTable();
                                    }}
                                    icon={RemoveTable}
                                />
                                {this.isMerged() && (
                                    <ToolbarButton
                                        isActive={false}
                                        onClick={() => {
                                            (this.props.editor as any).unmergeCells(this.props, [this.props.editor.value.anchorBlock]);
                                        }}
