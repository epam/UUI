...
import { ReactEditor as Editor } from 'slate-react';
...
export function ToolbarFunction(): any {
    const virtualReferenceElement = (): any => {
        ...
        // return {
        //     clientWidth: toolbar?.getBoundingClientRect().width,
        //     clientHeight: toolbar?.getBoundingClientRect().height,
    ...
    const renderButton = (): any => {
        return null; //<Button editor={ this.props.editor } key={ `toolbar-button-${index}` } />;
    };
