...
//         const transfer: any = event;
//         if (transfer.type !== 'html') return next();
//         const html = htmlclean(transfer.html);
//         //const { document } = this.serializer.deserialize(html);
//         editor.insertFragment(html);
//         event.preventDefault();
//     }
//
//     onKeyDown = (event: KeyboardEvent, editor: any, next: () => any) => {
...
//         }
//
//         return false; //isEditorEmpty(this.props.value);
//     }
//
//     onChange = (props: any) => {
...
//     }
//
//     onFocus = (e: any, editor: any, next: () => any) => {
//         if (editor.value.selection.isFocused) return;
//         return next();
//     }
//
