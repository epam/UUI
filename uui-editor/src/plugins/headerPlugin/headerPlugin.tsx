...
import { HEADER_TYPE_H1, HEADER_TYPE_H2, HEADER_TYPE_H3, HEADER_TYPE_H4, HEADER_TYPE_H5, HEADER_TYPE_H6, HeaderType, HeadersConfig, defaultHeadersConig } from './constants';
import { HeaderPluginOptions } from './types';

export const headerPlugin = (headersConfig?: HeadersConfig): PlatePlugin => {
