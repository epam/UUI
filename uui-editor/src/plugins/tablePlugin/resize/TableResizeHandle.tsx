...
import { createPrimitiveComponent, useElement, usePlateEditorState } from '@udecode/plate-common';
import { ResizeDirection, ResizeEvent, isTouchEvent } from '@udecode/resizable';
import { TTableElement, getTableEntries } from '@udecode/plate-table';
