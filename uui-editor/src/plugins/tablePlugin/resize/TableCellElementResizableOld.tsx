...
import { useElement, usePlateEditorState } from "@udecode/plate-common";
import { TTableElement, getTableEntries, useTableCellElementResizable } from "@udecode/plate-table";
...
export const TableCellElementResizable = (props) => {
