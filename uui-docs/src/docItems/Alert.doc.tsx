...
export const AlertExplorerConfig: TDocConfig = {
    name: 'Alert',
...
export const AlertDocItem: DocItem = {
    id: 'alert',
    name: 'Alert',
    parentId: 'components',
    examples: [
        { descriptionPath: 'alert-descriptions' },
        { name: 'Basic', componentPath: './_examples/alert/Basic.example.tsx' },
        { name: 'Sizes', componentPath: './_examples/alert/Sizes.example.tsx' },
    ],
    explorerConfig: AlertExplorerConfig,
};
