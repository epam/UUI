...
export const rangeDatePickerExplorerConfig: TDocConfig = {
    ...
    preview: (docPreview: DocPreviewBuilder<uui.RangeDatePickerProps>) => {
        ...
        docPreview.add(TRangeDatePickerPreview['States'], { ...baseMatrix, ...statesBaseMatrix }, w320_h60);
        docPreview.add(TRangeDatePickerPreview.Opened, { value: { values: [TEST_DATA.value] }, presets: { examples: ['default'] } }, w768_h500);
    },
};

export const RangeDatePickerDocItem: DocItem = {
    id: 'rangeDatePicker',
    name: 'Range Date Picker',
    parentId: 'components',
    examples: [
        { descriptionPath: 'rangeDatePicker-descriptions' },
        { name: 'Basic', componentPath: './_examples/rangeDatePicker/Basic.example.tsx' },
        { name: 'Presets and Footer', componentPath: './_examples/rangeDatePicker/PresetsAndFooter.example.tsx' },
        { name: 'Prevent component being empty', componentPath: './_examples/rangeDatePicker/PreventEmpty.example.tsx' },
    ],
    explorerConfig: rangeDatePickerExplorerConfig,
};
