...
import {
    COLOR_MAP, DocBuilder, DocPreviewBuilder, getColorPickerComponent, TDocConfig, TDocContext,
    TPreviewCellSize, TSkin,
} from '../';
import { TMultiSwitchPreview } from './_types/previewIds';
import { DocItem } from './_types/docItem';

export const multiSwitchExplorerConfig: TDocConfig = {
    name: 'MultiSwitch',
    ...
    doc: (doc: DocBuilder<uui.MultiSwitchProps<any>>, params) => {
...
export const MultiSwitchDocItem: DocItem = {
    id: 'multiSwitch',
    name: 'MultiSwitch',
    parentId: 'components',
    examples: [
        { descriptionPath: 'multiSwitch-descriptions' },
        { name: 'Basic', componentPath: './_examples/multiSwitch/Basic.example.tsx' },
    ],
    explorerConfig: multiSwitchExplorerConfig,
};
