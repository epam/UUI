...
export const featureClasses: FeatureClass[] = [
    ...
    { id: "PPLA", name: "Seat of a first-order administrative division", description: "Seat of a first-order administrative division (PPLC takes precedence over PPLA)", order: 'b' },
    { id: "PPLA2", name: "Seat of a second-order administrative division", order: 'c' },
    { id: "PPLA3", name: "Seat of a third-order administrative division", order: 'd' },
    { id: "PPLA4", name: "Seat of a fourth-order administrative division", order: 'e' },
    { id: "PPLC", name: "Capital of a political entity", order: 'f' },
    ...
    { id: "PPLX", name: "Section of populated place", order: 'p' },
    { id: "STLMT", name: "Israeli settlement", order: 'q' },
];