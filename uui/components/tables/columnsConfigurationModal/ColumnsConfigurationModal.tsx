...
const renderGroupTitle = (title: string, amount: number) => <FlexRow size="24" padding="24" spacing="6" cx={ styles.groupTitle }>
    <Text cx={ styles.groupTitleText } font="semibold" lineHeight="24" fontSize="14">{ title }</Text>
                        ...
                        { renderHidden() }
                        {
                            isNoData && (
                                <FlexRow cx={ styles.noData }>
                                    <Text fontSize='24' lineHeight='30' color='primary' font='semibold'>{ i18nLocal.noResultsFound.text }</Text>
                                    <Text fontSize='16' lineHeight='24' font='regular' color='primary'>{ i18nLocal.noResultsFound.subText }</Text>
                                </FlexRow>
                            )
                        }
                    </ScrollBars>
