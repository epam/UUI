...
import { DropdownMenuBody, DropdownMenuButton, DropdownSubMenu, DropdownMenuSplitter, DropdownMenuHeader } from '../';
...
describe('DropdownMenu', () => {
    it('should be rendered DropdownMenuBody correctly', () => {
        const tree = renderer
            .create(<DropdownMenuBody onClose={ () => {} } style={ { maxWidth: "250px" } }>
                <DropdownMenuButton
