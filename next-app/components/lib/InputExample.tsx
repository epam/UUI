        ...
        <Panel cx={ 'withGap' } rawProps={ {
            ...
            <FlexRow>
                <LabeledInput htmlFor='haveBackground' label='Have background' labelPosition='left'>
                    <Switch id='haveBackground' isDisabled={ isDisabled } value={ hasBackground } onValueChange={ (newVal: boolean) => {
                        setHasBackground(newVal);
                    } }  />
                </LabeledInput>
            </FlexRow>
            <FlexRow>
                <Checkbox label='Some label' value={ valueBool } onValueChange={ onValueChangeBool }/>
            </FlexRow>
            <FlexRow>
            ...
            <FlexRow>
                <FlexCell width={ 'auto' }>
                    <LabeledInput label='Some label' >
                        <TextInput value={ valueText } onValueChange={ onValueChangeText } placeholder='Please type text' />
                    </LabeledInput>
                </FlexCell>
            </FlexRow>
        </Panel>
