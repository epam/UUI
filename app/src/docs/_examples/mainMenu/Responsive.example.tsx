    ...
    const renderBurger = (hiddenItems: AdaptiveItemProps<{ caption?: string }>[]): ReactNode => (
        <>
            ...
            {hiddenItems
                .filter(i => i.caption)
                .map(i => (
                    <BurgerButton caption={i.caption} />
                ))}
        </>
    );
        ...
        return [
            {
                ...
                render: (item, hiddenItems) => <Burger renderBurgerContent={() => renderBurger(hiddenItems)} />,
            },
            {
                id: 'logo',
                priority: 99,
            ...
            { id: 'Subscriptions', priority: 3, render: () => <MainMenuButton href="/" caption="Subscriptions" />, caption: 'Subscriptions' },
            {
                ...
                priority: 8,
                collapsedContainer: true,
                render: (item, hiddenItems) => <MainMenuDropdown caption="More" children={hiddenItems?.map(i => i.render(item))} />,
            },
