    ...
    return (
        <FlexCell width="auto" cx={css.container}>
            ...
            <LabeledInput label="With disableLocaleFormatting">
                <NumericInput value={value} onValueChange={onValueChange} disableLocaleFormatting={true} />
            </LabeledInput>
            <LabeledInput label="No fraction digits">
                <NumericInput value={value} onValueChange={onValueChange} formatOptions={{ maximumFractionDigits: 0 }} />
            </LabeledInput>
            <LabeledInput label="Max 2 fractional digits">
                <NumericInput value={value} onValueChange={onValueChange} formatOptions={{ minimumFractionDigits: 2, maximumFractionDigits: 2 }} />
            </LabeledInput>
            ...
            <LabeledInput label="Units (meters)">
                <NumericInput value={value} onValueChange={onValueChange} formatOptions={{ style: 'unit', unit: 'meter' }} />
            </LabeledInput>
        </FlexCell>
    );
}
