        ...
        <Panel shadow cx={ css.container }>
            <div className={ css.wrapper }>
                ...
                <FlexRow alignItems="center" columnGap="6">
                    <Badge color="success" size="18" fill="semitransparent" icon={ notificationIcon } caption="Available" />
                    <Badge color="info" size="18" fill="semitransparent" caption="Bench" />
                    <Badge color="warning" size="18" fill="semitransparent" caption="Remote" />
                </FlexRow>
            </div>
