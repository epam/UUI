            ...
            <DropdownContainer vPadding='24' padding='18' { ...props }>
                <FlexRow alignItems='center' spacing='12'>
                    <Avatar
                        size='48'
                        alt='avatar'
                        img={ `https://avatars.dicebear.com/api/human/${name}.svg?background=%23EBEDF5&radius=50` }
                    />

                    <FlexCell width='100%'>
                        <Text cx={ css.text } lineHeight='24' fontSize='16' color='gray80' font='sans-semibold'>{ name }</Text>
