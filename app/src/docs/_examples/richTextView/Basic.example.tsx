    ...
    return (
        <>
            <RichTextView>
                ...
                <h3>
                    H3 - Large area heading (for big cards or free space areas)
                </h3>
                <h4>
                    H4 - Medium area heading (for thin/small cards and areas)
                </h4>
                <h5>
                    H5 - Small area heading (for small cards as attention
                    drawer)
                </h5>
                <h6>
                    H6 - Super small heading or accent — Emphasis (for title or
                    label of lists)
                </h6>
                <h3>
                ...
                <h3 className="promo-header">
                    Promo heading — H3 <br /> for areas smaller than
                    hero-headers
                </h3>
                <h1>Example text with headline h1</h1>
                <h2>And additional headline h2</h2>
                <p>
                    <b>Main text</b> — Default is here… Further is a fish →
                ...
                <p>
                    ...
                    or avoids pleasure itself, <i>because it is pleasure</i>,
                ...
                <p>
                    ...
                    capacity is kept constant, and equilibrates with the gases
                    dissolved in the pulmonary capillary blood, and thus
                    throughout the body.
                </p>
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <i>
                                    The candidate is sociable and speaks English
                                    well
                                </i>
                                <ul>
                                    <li>
                    ...
                    <li>
                        He is passionate about his profession, Pavel is oriented
                        in professional information resources and webinars for
                        growth as a professional. He is passionate about his
                        profession, Pavel is oriented in professional
                        information resources and webinars for growth as a
                        professional.
                    </li>
                    <li>
                        Pavel seems to be flexible when achieving the result and
                        ready to accept conditions for projects.
                    </li>
                    <li>
                        The candidate is sociable and speaks English well. He
                        works at the customer side and negotiates with regard to
...
export const MyComponent = <div className={ css.myHeader }>`}</pre>
                ...
                <p className={cx(css.typography12)}>
                    ...
                    voluptate velit esse cillum dolor in reprehenderit in
