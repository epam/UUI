    ...
    return (
        <>
            <RichTextView>
                ...
                <p>
                    <b>Main text</b> — Default is here… Further is a fish → While it was just a TV show, that little speech at the beginning of the original Star Trek
                ...
                <p>
                    <code>{`import { Button } from '@epam/loveship'`}</code> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                    ...
                    irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. <code>{`import { Button } from '@epam/loveship'`}</code>
                ...
                <p>
                    ...
                    avoids pleasure itself, <i>because it is pleasure</i>, but because those who do not know how to pursue pleasure rationally encounter consequences that
...
export const MyComponent = <div className={ css.myHeader }>`}</pre>
                ...
                <p className={cx(css.typography12)}>
                    ...
                    in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. <code>{`import { Button } from '@epam/loveship'`}</code>
                    Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                </p>
                <p className={cx(css.typography12)}>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,{' '}
