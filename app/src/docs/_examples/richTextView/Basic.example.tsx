        ...
        <>
            <RichTextView>
                ...
                <div className="hero-header">
                    Hero HEADING — Hero <br /> for super-promo screens
                </div>
                <h2 className="promo-header">
                    Promo heading — H2 <br /> for page hero-headers
                </h2>
                <h3 className="promo-header">
                    Promo heading — H3 <br /> for areas smaller than hero-headers
                </h3>
                <h1>Example text with headline h1</h1>
                <h2>And additional headline h2</h2>
                <p>
                    <b>Main text</b> — Default is here… Further is a fish → While it was just a TV show, that little speech at the beginning of the
                    original Star Trek show really did do a good job if capturing our feelings about space. cillum dolore eu fugiat nulla pariatur.{' '}
                    <Anchor href="/">
                ...
                <p>
                    <code>{`import { Button } from '@epam/loveship'`}</code> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                    ...
                    pariatur. <code>{`import { Button } from '@epam/loveship'`}</code>
                ...
                <p>
                    ...
                    happiness. No one rejects, dislikes, or avoids pleasure itself, <i>because it is pleasure</i>, but because those who do not know
                ...
                <p>
                    Physiological respiration involves the mechanisms that ensure that the composition of the functional residual capacity is kept
                    constant, and equilibrates with the gases dissolved in the pulmonary capillary blood, and thus throughout the body.
                </p>
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            <li>
                                He is <q>passionate about his profession</q>
                            </li>
                            <li>
                                Pavel <s>seems to be flexible when</s>
                            </li>
                            <li>
                                <i>The candidate is sociable and speaks English well</i>
                                <ul>
                                    <li>
                                        One more inside lists <u>with underline text</u>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <li>The candidate is sociable and speaks English well</li>
                    <li>
                        He is passionate about his profession, Pavel is oriented in professional information resources and webinars for growth as a
                        professional. He is passionate about his profession, Pavel is oriented in professional information resources and webinars for
                        growth as a professional.
                    </li>
                    <li>Pavel seems to be flexible when achieving the result and ready to accept conditions for projects.</li>
                    <li>
                        The candidate is sociable and speaks English well. He works at the customer side and negotiates with regard to business goals
                        and his individual.{' '}
                    </li>
                </ul>
...
export const MyComponent = <div className={ css.myHeader }>`}</pre>
                ...
                <p className={cx(css.typography16)}>
                    ...
                    velit esse cillum dolore eu fugiat nulla pariatur. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu
                    fugiat nulla pariatur. <code>{`import { Button } from '@epam/loveship'`}</code>
                    Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                </p>
                <p className={cx(css.typography16)}>
                    Lorem ipsum dolor sit amet,{' '}
                ...
                <p className={cx(css.typography12)}>
                    ...
                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure reprehenderit in voluptate
                    velit esse cillum dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.{' '}
