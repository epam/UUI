                ...
                (props: INotification): ReactNode => (
                    <NotificationCard {...props} color="gray60">
                        <RichTextView>
                            <h3>Title</h3>
                            <p>
                                <u>Some description</u>. If you want, <strong>you can</strong> redirect to <a href="https://www.google.com/">Google</a>
                            </p>
                        </RichTextView>
                    </NotificationCard>
                ),
            ...
            <FlexRow size="48" padding="12" spacing="12">
                ...
                <FlexCell width={200}>
                    <PickerInput
                        ...
                        dataSource={
                            new ArrayDataSource({
                                items: ['bot-left', 'top-left', 'bot-right', 'top-right', 'top-center', 'bot-center'].map((name) => ({ id: name, name })),
                            })
                        }
