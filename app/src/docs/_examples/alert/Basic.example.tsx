...
export default function BasicAlertExample() {
    return (
        <FlexCell cx={ css.container } grow={ 1 }>
            <SuccessAlert> <Text size="30"> Success notification </Text> </SuccessAlert>
            <WarningAlert> <Text size="30"> Warning notification </Text> </WarningAlert>
            <ErrorAlert> <Text size="30"> Error notification </Text> </ErrorAlert>
