...
export default function DefaultLinkButtonExample() {
    const renderDropdownBody = () => <Panel background="surface" shadow><Text>Dropdown body</Text></Panel>;

    return (
        <div className={ css.wrapper }>
            <Panel background="surface" cx={ css.components }>
            ...
            <Panel background="surface" cx={ css.descriptions }>
