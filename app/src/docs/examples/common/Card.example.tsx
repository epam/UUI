...
import { Avatar, Badge, FlexCell, FlexRow, LinkButton, Panel, Text } from '@epam/promo';
        ...
        <Panel shadow cx={ css.container }>
            <div className={ css.wrapper }>
                ...
                <FlexRow alignItems="center" columnGap="6" >
                    <Badge color="green" size="18" fill="semitransparent"
                            icon={ notificationIcon } caption="Available"/>
                    <Badge color="blue" size="18" fill="semitransparent"
                            caption="Bench"/>
                    <Badge color="cyan" size="18" fill="semitransparent"
                            caption="Remote"/>
                </FlexRow>
            </div>
            ...
            <div className={ css.wrapper }>
                <FlexRow>
                    <LinkButton caption='Show Reporting Line' link={ { pathname: '/' } } size='24'
                        icon={ navigationIcon } iconPosition='right' />
                </FlexRow>
            </div>
        </Panel>
    );
