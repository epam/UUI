                                ...
                                {basicColors[nameColor].map((color, index) => {
                                    return (
                                        <div key={index} className={cx(css.box, css.basicColorBox, style[`color-${nameColor}`])}>
                                            ...
                                            {color.hasVariable && (
                                                <div
                                                    className={cx(css.colorName, color.contrastText && css.contrastText)}
                                                    onClick={() => {}}
                                                >{`$${nameColor}`}</div>
                                            )}
                                        </div>
    ...
    renderGrayscaleColors() {
        return (
            <RichTextView size="16" cx={css.container}>
                ...
                <p>
                    These colors are used for borders, separators, icons, text and backgrounds. Each grayscale has its own specific purpose. Please do
                    not change the purpose of the shades.
                </p>
            </RichTextView>
        );
    }
