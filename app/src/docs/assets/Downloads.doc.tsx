                ...
                <FlexRow alignItems="top" cx={css.headerRow}>
                    <FlexCell width="100%" cx={css.contentBlock}>
                        <RichTextView size="16">
                            ...
                            <p>
                                For full-scale work with design documents you need to install the component library. Here you will find detailed
                                instructions on how to install the library, additional files and answers to frequent questions.
                            </p>
                        </RichTextView>
