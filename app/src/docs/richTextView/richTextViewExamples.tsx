...
const COMPONENTS_BY_SKIN = {
    [TSkin.UUI3_loveship]: {
        Anchor: loveship.Anchor,
        FlexRow: loveship.FlexRow,
        LabeledInput: loveship.LabeledInput,
        LinkButton: loveship.LinkButton,
        TextInput: loveship.TextInput,
        ControlWrapper: loveship.ControlWrapper,
    },
    [TSkin.UUI4_promo]: {
        Anchor: promo.Anchor,
        FlexRow: promo.FlexRow,
        LabeledInput: promo.LabeledInput,
        LinkButton: promo.LinkButton,
        TextInput: promo.TextInput,
        ControlWrapper: promo.ControlWrapper,
    },
    [TSkin.UUI]: {
        Anchor: uui.Anchor,
        FlexRow: uui.FlexRow,
        LabeledInput: uui.LabeledInput,
        LinkButton: uui.LinkButton,
        TextInput: uui.TextInput,
        ControlWrapper: (props: { children: any }) => props.children,
    },
};
export const getRichTextViewExamples = (skin: TSkin) => {
    const { TextInput, LabeledInput, LinkButton, FlexRow, Anchor, ControlWrapper } = COMPONENTS_BY_SKIN[skin];
    const htmlContent = [
