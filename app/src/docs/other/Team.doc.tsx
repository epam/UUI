...
export const team = [
    ...
    { name: 'Yaroslav Kuznietsov', position: 'Key Developer', isDefault: true, src: 'https://static.cdn.epam.com/avatar/5bd81713fc00b7fac7299fdc0896a796.jpg', link: 'https://telescope.epam.com/who/Yaroslav_Kuznietsov' },
