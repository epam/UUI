...
export const projectsList: Array<{ projectName: string; projectCode: string; icon: Icon; url: string }> = [
    ...
    {
        projectName: 'Employment Verification Letter',
        projectCode: 'EPM-GOOG',
        icon: EmploymentVerificationLetterIcon,
        url: 'https://letter.epam.com/',
    },
                        ...
                        <div key={project.projectName} className={css.projectContainer}>
                            <FlexRow cx={css.projectRow} padding="18">
                                ...
                                <LinkButton
                                    ...
                                    icon={TelescopeIcon}
                                    caption="View Team"
                                    href={this.getTeamLink(project.projectCode)}
                                />
                            </FlexRow>
                        </div>
                    ))}
