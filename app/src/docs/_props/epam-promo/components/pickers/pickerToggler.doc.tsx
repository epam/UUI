...
import { PickerToggler, PickerTogglerMods } from '@epam/promo';
...
const PickerTogglerDoc = new DocBuilder<PickerTogglerProps<any, any> & PickerTogglerMods>({ name: 'PickerToggler', component: PickerToggler })
    ...
    .implements([isDisabledDoc, isReadonlyDoc, iconDoc, iconOptionsDoc, dropdownTogglerDoc, iEditable, IHasEditModeDoc])
