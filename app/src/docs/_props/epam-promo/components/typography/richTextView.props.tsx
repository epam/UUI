        ...
        examples: [
            {
                value: (
                    <div style={{ maxWidth: '1100px' }} className={style.container}>
                        ...
                        <h2>Example text</h2>
                        <p>
                            <b>Main text</b> — Default is here… Further is a fish → While it was just a TV show, that little speech at the beginning of the original Star
                        ...
                        <p>
                            ...
                            velit esse cillum dolore eu fugiat nulla pariatur. <code>{`import { Button } from '@epam/loveship'`}</code>
                        ...
                        <p>
                            ...
                            dislikes, or avoids pleasure itself, <i>because it is pleasure</i>, but because those who do not know how to pursue pleasure rationally
