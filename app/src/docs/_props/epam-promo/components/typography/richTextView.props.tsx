        ...
        examples: [
            {
                value: (
                    <div style={{ maxWidth: '1100px' }} className={style.container}>
                        ...
                        <h2>Headlines</h2>
                        <h1>
                            Heading — H1 <br /> for page hero-headers
                        </h1>
                        <h2>
                            Heading — H2 <br /> for areas smaller than hero-headers
                        </h2>
                        <h3>
                            Large area heading — H3 <br /> for big cards or free space areas
                        </h3>
                        <h4>
                            Medium area heading — H4 <br /> for thin/small cards and areas
                        </h4>
                        <h5>
                            Small area heading — H5 <br /> for small cards as attention drawer
                        </h5>
                        <h6>
                            Super small heading or accent — Emphasis <br /> for title or label of lists
                        </h6>
                        <h2>Example text</h2>
                        <p>
                            <b>Main text</b> — Default is here… Further is a fish → While it was just a TV show, that little speech at the beginning
                            of the original Star Trek show really did do a good job if capturing our feelings about space. cillum dolore eu fugiat
                            nulla pariatur.{' '}
                            <Anchor href="/">
                        ...
                        <p>
                            ...
                            of human happiness. No one rejects, dislikes, or avoids pleasure itself, <i>because it is pleasure</i>, but because those
                        ...
                        <ul>
                            ...
                            <li>The candidate is sociable and speaks English well</li>
                            <li>
                                He is passionate about his profession, Pavel is oriented in professional information resources and webinars for growth
                                as a professional. He is passionate about his profession, Pavel is oriented in professional information resources and
                                webinars for growth as a professional.
                            </li>
                            <li>Pavel seems to be flexible when achieving the result and ready to accept conditions for projects.</li>
                            <li>
                                The candidate is sociable and speaks English well. He works at the customer side and negotiates with regard to
                                business goals and his individual.{' '}
                            </li>
                        </ul>
...
export const MyComponent = <div className={ css.myHeader }>`}</pre>
                        ...
                        <p className={cx(css.typography16)}>
                            ...
                            in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Duis aute irure dolor in reprehenderit in voluptate velit
                            esse cillum dolore eu fugiat nulla pariatur. <code>{`import { Button } from '@epam/loveship'`}</code>
                            Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                        </p>
                        ...
                        <p className={cx(css.typography12)}>
                            ...
                            quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure reprehenderit in
                            voluptate velit esse cillum dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.{' '}
                            <code>{`import { Button } from '@epam/loveship'`}</code>
                            Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                        </p>
                    </div>
