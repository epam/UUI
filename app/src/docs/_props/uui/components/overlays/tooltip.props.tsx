...
const tooltipDoc = new DocBuilder<TooltipProps & TooltipMods>({ name: 'Tooltip', component: Tooltip })
    .prop('content', {
        examples: [
            ...
            { value: 'kolbasa kolbasa kolbasa kolbasa kolbasa kolbasa kolbasa kolbasa kolbasa kolbasa kolbasa kolbasa kolbasa kolbasa', name: 'long text' },
        ],
        type: 'string',
    })
    .prop('children', {
        examples: [
            { value: <Button color="primary" size="36" caption="Button" />, name: 'Blue button', isDefault: true },
            { value: <Sfc>123</Sfc>, name: 'sfc' },
        ],
    })
    .prop('placement', {
        examples: [
