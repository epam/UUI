...
import { RowMods, Button, Text, FlexCell } from '@epam/uui';
import { FlexCellProps } from '@epam/uui-core';
import { DocBuilder } from '@epam/uui-docs';
import { onClickDoc } from '../../../docs';
import { FlexRowContext } from '../../../docs/contexts/FlexRowContext';
        ...
        examples: [
            {
                ...
                name: 'Button',
                value: <Button color="accent" caption="Submit" rawProps={ { style: { width: '100%' } } } />,
                isDefault: true,
            },
        ],
    })
