import { deprecatedLinkButtonColors, allLinkButtonColors, LinkButton, LinkButtonProps } from '@epam/loveship';
...
// LinkButtonColors without deprecated colors
...
const LinkButtonDoc = new DocBuilder<LinkButtonProps>({ name: 'LinkButton', component: LinkButton })
    ...
    .prop('color', {
        ...
        examples: actualLinkButtonColors,
    })
    .prop('caption', {
        examples: [
