...
import { Paginator } from '@epam/loveship';
import { PagePanelContext, iEditable, DefaultContext } from '../../docs';
...
const paginatorDoc = new DocBuilder<PaginatorProps>({ name: 'Paginator', component: Paginator })
    ...
    .prop('value', {
        examples: [
            1, { value: 5, isDefault: true }, 6, 8,
        ],
        isRequired: true,
    })
    .prop('totalPages', {
        examples: [
            5, 8, { value: 10, isDefault: true }, 100, 1000,
        ],
        isRequired: true,
    })
    .withContexts(DefaultContext, PagePanelContext);
