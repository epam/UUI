...
export class DropdownMenuContext extends React.Component<DemoComponentProps, DropdownComponentState> {
        ...
        return (
            <DropdownMenuBody color={color}>
                <DropdownMenuSearch
                    ...
                    onValueChange={newValue => this.setState({ searchValue: newValue })}
    ...
    render() {
        return (
            <Panel margin="24">
                <FlexRow>
                    <Dropdown renderTarget={props => <Button caption="white" {...props} />} renderBody={this.renderBody.bind(this, 'white')} />
                    <Dropdown renderTarget={props => <Button caption="night" {...props} />} renderBody={this.renderBody.bind(this, 'night')} />
                </FlexRow>
            </Panel>
        );
    }
