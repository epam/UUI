...
import { Panel, LabeledInput, TextInput, Switch, FlexRow, RadioGroup, ControlSize, Button, Checkbox, FlexCell, ControlWrapper, CheckboxGroup, FlexSpacer } from '@epam/loveship';
    ...
    render() {
        ...
        return (
            <Panel shadow cx={ css.panel } background='white' margin="24">
                ...
                <FlexRow type="form">
                    <FlexSpacer />
                    <Button size={ size } fill="none" color="night600" caption="Cancel"/>
