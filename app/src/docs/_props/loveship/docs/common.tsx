...
import { allSizes, SizeMod, FontMod, ColorMod, allFontStyles, allEpamBadgeColors, allLinkButtonColors, commonControlColors } from '@epam/loveship';
...
export const LinkButtonColorDoc = new DocBuilder<ColorMod>({ name: 'Color' }).prop('color', {
    renderEditor: (editable, examples) => <ColorPicker colors={ examples.map((i) => ({ value: i, hex: colors[i] })) } { ...editable } />,
