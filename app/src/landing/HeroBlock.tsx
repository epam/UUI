                        ...
                        <div className={css.layout} ref={measureRef}>
                            <FlexRow cx={css.hero}>
                                <div className={css.heroText}>
                                    ...
                                    <Text font="sans" fontSize="24" cx={css.heroSecondary}>
                                        No more need to build user interface from scratch every time. Just use "lego blocks" to assemble new pages in
                                        a quick way for any current or new EPAM product.
                                    </Text>
                                </div>
