                ...
                <div className={css.landingQuote}>
                    <div className={css.card}>
                        ...
                        <Text font="sans" lineHeight="24" fontSize="16" size="none">
                            Solution Architect, UUI
                        </Text>
                    </div>
                    <div className={css.text}>
                        <Text font="museo-slab" cx={css.quoteText}>
                            UUI is highly customizable, it can even be seen as "accelerator of UI accelerators". It's built on top of a non-styled set
                            of components, so code can be reused.
                        </Text>
                        <Text font="museo-slab" cx={css.quoteText}>
                            During 5+ years of experience we learned how to build the brand UI: from ideas and design, via accelerators, to the great
                            products.
                        </Text>
                    </div>
                </div>
