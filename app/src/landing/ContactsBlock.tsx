                                    ...
                                    <FlexRow cx={ css.contactsCards } vPadding='48' >
                                        <div className={ css.card } >
                                            { containerWidth > 1280
                                                ...
                                                : <Anchor rawProps={{ 'aria-label': 'Github', rel: 'noreferrer noopener' }} href={ GIT_LINK } target='_blank' >
                                        ...
                                        <div className={ css.card } >
                                            { containerWidth > 1280
                                                ...
                                                : <Anchor rawProps={{ 'aria-label': 'Email', rel: 'noreferrer noopener' }}  href={ `mailto:${ EMAIL }` } target='_blank' >
