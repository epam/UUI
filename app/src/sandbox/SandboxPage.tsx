...
import { DisabledCheckboxesTable } from './disabledCheckboxesTable/DisabledCheckboxesTable';
...
export function SandboxPage() {
    const items = useMemo(
        () => [
            ...
            { id: 'disabledCheckboxes', name: 'Disabled checkboxes', component: DisabledCheckboxesTable }, 
        ],
        [],
    );
