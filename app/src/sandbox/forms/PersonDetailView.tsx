        ...
        return (
            <div className={css.horizontal}>
                    ...
                    <FlexRow type="form">
                        ...
                        <FlexCell grow={1}>
                            <LabeledInput label="Time">
                                <Text>
                                    {this.props.value.timeValue && this.props.value.timeValue.hours}:{this.props.value.timeValue && this.props.value.timeValue.minutes}
                                </Text>
                            </LabeledInput>
                        </FlexCell>
                    </FlexRow>
                ...
                <Panel>
                    ...
                    <FlexRow type="form">
                        <FlexCell grow={1}>
                            <LabeledInput label="Slider" {...this.props.lens.prop('vacDays').toProps()}>
                                <Slider isDisabled={true} min={0} max={40} step={1} {...this.props.lens.prop('vacDays').toProps()} />
                            </LabeledInput>
                        </FlexCell>
                        <FlexCell grow={1}>
                            <LabeledInput label="Range" {...this.props.lens.prop('bracket').toProps()}>
                                <RangeSlider isDisabled={true} min={-12} max={13} step={7} {...this.props.lens.prop('bracket').toProps()} />
                            </LabeledInput>
                        </FlexCell>
                    </FlexRow>
                    <ExperienceEditor {...this.props.lens.prop('experience').toProps()} isDisabled={true} />
                </Panel>
            </div>
        );
    }
