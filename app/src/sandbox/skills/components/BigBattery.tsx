        ...
        <FlexRow cx={ cx(css.batteryMainContainer) }>
            <FlexRow cx={ cx(css.ratingWrapper) }>
                <div className={ css.itemContainer }>
                    <div
                        className={ cx(css.ratingBlock, getRating(props.rating) >= 1 && css.active) }
                ...
                <div className={ css.itemContainer }>
                    <div
                        className={ cx(css.ratingBlock, getRating(props.rating) >= 2 && css.active) }
                ...
                <div className={ css.itemContainer }>
                    <div
                        className={ cx(css.ratingBlock, getRating(props.rating) >= 3 && css.active) }
                ...
                <div className={ css.itemContainer }>
                    <div
                        className={ cx(css.ratingBlock, getRating(props.rating) === 4 && css.active) }
