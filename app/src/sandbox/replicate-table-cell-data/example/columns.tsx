...
import { ReplicationMarker } from "../components";
import { useReplication } from "../hooks";

export const COLUMN_IDS: (keyof DataItemExample)[] = ['column0', 'column1', 'column2',
    // 'column3', 'column4'
];
export const COLUMNS_DATA_TYPES: string[] = ['number', 'number', 'number'];
