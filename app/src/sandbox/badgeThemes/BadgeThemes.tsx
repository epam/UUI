...
const uuiBadges: Array<UuiBadgeProps & { key: string }> = [
    ...
    { key: '2', indicator: true, size: '42', color: 'white' },
    ...
    { key: '6', indicator: true, size: '48', color: 'critical' },
    ...
    { key: '12', fill: 'outline', indicator: true, size: '48', color: 'critical' },
];
...
const loveshipBadges: Array<LoveshipBadgeProps & { key: string }> = [
    ...
    { key: '16', indicator: true, shape: 'round', size: '42', color: 'lavanda' },
    ...
    { key: '23', fill: 'outline', indicator: true, shape: 'round', size: '42', color: 'lavanda' },
...
const promoBadges: Array<PromoBadgeProps & { key: string }> = [
    ...
    { key: '17', indicator: true, size: '42', color: 'lavanda' },
    ...
    { key: '24', fill: 'outline', indicator: true, size: '42', color: 'lavanda' },
...
const electricBadges: Array<PromoBadgeProps & { key: string }> = [
    ...
    { key: '6', indicator: true, size: '42', color: 'lavanda' },
    ...
    { key: '13', fill: 'outline', indicator: true, size: '42', color: 'lavanda' },
