    ...
    return (
        <Panel cx={ [css.panel, css.uuiThemePromo] } background="white" margin="24">
            ...
            <FlexRow padding="24" borderBottom background="none">
                <TabButton caption={ Pages.Form } isActive={ page === Pages.Form } onClick={ page !== Pages.Form ? () => setPage(Pages.Form) : null } size="60" />
                <TabButton caption={ Pages.Modal } isActive={ page === Pages.Modal } onClick={ page !== Pages.Modal ? () => setPage(Pages.Modal) : null } size="60" />
                <TabButton caption={ Pages.Anchor } isActive={ page === Pages.Anchor } onClick={ page !== Pages.Anchor ? () => setPage(Pages.Anchor) : null } size="60" />
            </FlexRow>
