...
export function ScrollSpyDemo() {
    ...
    const getScrollSpyDemoPage = () => {
        switch(page) {
            case Pages.Form: return <ScrollSpyForm />;
            case Pages.Modal: return <ScrollSpyModal />;
            case Pages.Anchor: return <ScrollSpyAnchor />;
        }
    }
        ...
        <Panel cx={ css.panel } background='white' margin='24'>
            ...
            <FlexRow padding='24' borderBottom background='none' >
                <TabButton
                    ...
                    onClick={ page !== Pages.Form ? () => setPage(Pages.Form) : null }
                    size='60'
                />
                <TabButton
                    caption={ Pages.Modal }
                    isLinkActive={ page === Pages.Modal }
                    onClick={ page !== Pages.Modal ? () => setPage(Pages.Modal) : null }
                    size='60'
                />
                <TabButton
                    caption={ Pages.Anchor}
                    isLinkActive={ page === Pages.Anchor }
                    onClick={ page !== Pages.Anchor ? () => setPage(Pages.Anchor) : null }
                    size='60'
                />
            </FlexRow>
            <ScrollBars>
                {getScrollSpyDemoPage()}
            </ScrollBars>
        </Panel>
    );
}
