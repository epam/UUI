...
export const productColumns: DataColumnProps<Product, number, DataQueryFilter<Product>>[] = [
    {
        ...
        isSortable: true,
        renderCell: props => (
            <DataTableCell padding="12" {...props.rowLens.prop('Name').toProps()} renderEditor={props => <TextInput {...props} />} {...props} />
        ),
    },
    {
        key: 'Class',
    ...
    },
    {
        ...
        textAlign: 'center',
        renderCell: props => (
            <DataTableCell {...props.rowLens.prop('FinishedGoodsFlag').toProps()} renderEditor={props => <Checkbox {...props} />} {...props} />
        ),
    },
    {
        key: 'ListPrice',
    ...
    },
    {
        ...
        textAlign: 'center',
        renderCell: props => (
            <DataTableCell {...props.rowLens.prop('MakeFlag').toProps()} renderEditor={props => <Checkbox {...props} />} {...props} />
        ),
    },
    {
        key: 'ModifiedDate',
