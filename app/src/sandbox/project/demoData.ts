...
const tasks: Partial<Task>[] = [
    ...
    { id: 10103, name: 'Test instances - Dev, QA, UAT' },
    { id: 10104, name: 'API connection & secrets management' },
    { id: 10105, name: 'Production instance' },
    ...
    { id: 404, name: 'Breadcrumbs' },
    { id: 405, name: 'Dashboard Cards Elements' },
    { id: 406, name: 'Forms headers/sub-headers' },
    { id: 407, name: 'Icons' },
    { id: 408, name: 'Masked input' },
    { id: 409, name: 'Master-detail screen' },
    { id: 410, name: 'Common Modal windows (e.g. confirmation)' },
    { id: 411, name: 'Stepper' },
    { id: 412, name: 'In-form Tables' },
    ...
    { id: 503, name: 'Full-screen table' },
    { id: 504, name: 'Full-screen form' },
    ...
    { id: 604, name: 'Favorites' },
    { id: 605, name: 'Comparison' },
    { id: 606, name: 'Check-out form' },
    { id: 607, name: 'Admin area' },
    { id: 60701, name: 'Products List' },
    { id: 60702, name: 'Product Form' },
