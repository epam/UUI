import OverviewDocItem from 'uui-doc-pages/components/overview.json';
import CoreConceptsDocItem from 'uui-doc-pages/components/coreConcepts.json';
import SupportDocItem from 'uui-doc-pages/components/support.json';
import GettingStartedDocItem from 'uui-doc-pages/components/gettingStarted.json';
import AccessibilityDocItem from 'uui-doc-pages/components/accessibility.json';
