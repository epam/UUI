...
const componentsStructure = sortBy(
    [
        ...
        { id: 'richTextView', name: 'View', component: RichTextViewDoc, parentId: 'richTextEditor' },
        ...
        { id: 'richTextEditorOverview', name: 'Overview', component: RichTextEditorDoc, parentId: 'richTextEditor' },
        { id: 'richTextEditorSerializers', name: 'Serializers', component: RichTextEditorSerializersDoc, parentId: 'richTextEditor' },
...
export const items: DocItem[] = [
    ...
    { id: 'richTextEditor', name: 'Rich Text Editor' },
