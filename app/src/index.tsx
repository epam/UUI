...
import { Router6AdaptedRouter, useUuiServices, UuiContext, IProcessRequest } from '@epam/uui-core';
import { i18n } from '@epam/uui';
import { AmplitudeListener, GAListener } from './analyticsEvents';
...
import '@epam/assets/theme/theme_fresh_4px.scss';
