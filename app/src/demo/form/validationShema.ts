        ...
        personalInfo: {
            props: {
                fullName: {
                    ...
                    validators: [
                        (value: string) => [
                            !fullNameRegExp.exec(value)?.length && 'Full Name should contain only Latin alphabet characters and numbers!',
                        ],
                    ],
                },
                birthdayDate: {
                    ...
                    validators: [
                        (value: string) => [
                            !(dayjs(value).valueOf() <= dayjs().subtract(16, 'year').valueOf()) && 'User cannot be under 16 years old!',
                        ],
                    ],
                },
            },
