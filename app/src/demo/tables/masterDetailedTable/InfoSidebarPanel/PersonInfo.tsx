...
import { Badge, BadgeColors, ScrollBars } from '@epam/uui';
...
export function PersonInfo({ data }: PersonInfoProps) {
    return (
        <ScrollBars>
            ...
            <InfoRow title="Status" value={ <Badge size="24" fill="outline" indicator caption={ data.profileStatus } color={ data.profileStatus.toLowerCase() as BadgeColors } /> } />
