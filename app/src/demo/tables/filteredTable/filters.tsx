...
import { Badge, DataPickerRow, PickerItem, defaultPredicates, FlexRow, BadgeColors } from '@epam/uui';
    ...
    return [
        {
            ...
            renderRow: (props) => (
                <DataPickerRow
                    ...
                    alignItems="center"
                    key={ props.rowKey }
                    renderItem={ (item: any) => <FlexRow size="36"><Badge size="24" fill="outline" indicator color={ item.name.toLowerCase() as BadgeColors } caption={ item.name } /></FlexRow> }
                />
            ),
