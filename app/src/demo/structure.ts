...
export const demoItems: DemoItem[] = [
    ...
    },
    {
        ...
        shortDescription: 'UUI contains a full-featured set of Form components – TextInputs, Date Pickers, etc. We also provide useForm hook – to manage form state, including validation.',
    },
    {
    ...
    },
    {
        ...
        shortDescription: '@epam/uui-timeline module provides components to build Gantt-chart-like experiences. It’s intended to be used as a basis to build your own experiences. You can render Gantt diagrams, time-based charts, etc. Components can be placed in various context – for example as table columns/cells.',
    },
];
